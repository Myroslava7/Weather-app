 ...
 * 15.12.2020
 * Kyiashko Myroslava
 * Создание одностраничного сайта с прогнозом погоды. 
 * Для получения прогноза использован https://openweathermap.org.
 */
'use strict';
let activeEl;
let coordCity,
...
fetch('https://ipinfo.io?token=b30f6c239c3f75')
  .then(function (resp) { return resp.json() })
